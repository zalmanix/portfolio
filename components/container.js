...
export default function Container(props) {
    ...
    return (
        <div className="bg-white dark:bg-black">
            ...
            <nav className="sticky top-0 flex items-center justify-between w-full max-w-4xl p-5 mx-auto my-0 text-gray-900 bg-white sticky-nav md:my-8 dark:bg-black bg-opacity-60 dark:text-gray-100">
                <div>
                    <NextLink href="/">
