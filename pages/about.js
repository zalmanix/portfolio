      ...
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <div className="bg-white mb-4">
          <p className="text-4 tracking-tight mb-4 text-black dark:text-white text-justify">
            I&apos;m a full-stack programmer currently working from home, I like to design web pages using Next.js, Angular, or Laravel, and developing small indie games in my spare time.
            I&apos;m enjoying challenges and difficult projects. I once tried 3D modeling in the blender, it didn&apos;t go that bad but my passion lies in programming. Besides sitting 12h a day before my PC I enjoy cooking meals for my entire family. In my free time, I read literature, specifically sci-fi and fiction. I have a golden retriever puppy named &quot; Alba&quot; witch I take on walks regularly to
            nearby forest. 
          </p>
        </div>
